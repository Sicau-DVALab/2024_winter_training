...
def main(args=None):
    ...
    parser.add_argument('--coco_path', default='C:\\Users\\two-pieces-shit\\Desktop\\rtinanet讲解版\\pytorch-retinanet-master\\pytorch-retinanet-master\\coco2014', help='Path to COCO directory')
    ...
    for epoch_num in range(parser.epochs):
        ...
        print('epoch: {} | Average Loss: {:1.5f}'.format(epoch_num, average_loss))

        # 保存损失历史到文本文件
        with open('loss_history.txt', 'a') as f:
            f.write('epoch: {} | Average Loss: {:1.5f}\n'.format(epoch_num, average_loss))
    # 在训练循环之后绘制损失历史
